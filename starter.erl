...
start(Id) ->
	...
	receive 
		{Name,Node} ->
			...
			receive
				{steeringval, ArbeitsZeit, TermZeit, GGTProzessnummer} -> %die steuernden Werte f�r die ggT-Prozesse werden im Starter Prozess gesetzt; Arbeitszeit ist die simulierte Zeit zur Berechnung, 				TermZeit ist die Wartezeit, bis eine Wahl f�r eine Terminierung initiiert wird und GGTProzessnummer ist die Anzahl der zu startenden ggT-Prozesse.
